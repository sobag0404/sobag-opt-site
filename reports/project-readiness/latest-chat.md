...
1. Current state: production exact `/api/auth/login`, `/api/auth/register`, `/api/auth/logout`, `/api/auth/me`, `/api/orders`, and `/api/briefs` are cut over to Rust. Latest deployed release: `20260616T180115Z-9932b03`.
