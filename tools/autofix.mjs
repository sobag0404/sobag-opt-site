...
function main() {
  ...
  run("node", ["tools/pim-postgres-migration-bundle-audit.mjs", "--dry-run"]);
  run("node", ["tools/pim-postgres-migration-bundle-audit.mjs", "--self-test"]);
  ...
  run("node", ["tools/catalog-db-write-smoke.mjs"]);
  run("node", ["tools/catalog-db-env-packet-audit.mjs"]);
  run("node", ["tools/catalog-db-env-packet-audit.mjs", "--self-test"]);
  run("node", ["tools/catalog-db-apply-plan.mjs", "--self-test"]);
  run("node", ["tools/catalog-db-write-plan-audit.mjs"]);
  run("node", ["tools/catalog-db-write-plan-audit.mjs", "--self-test"]);
  run("node", ["tools/catalog-db-write-rehearsal.mjs"]);
  run("node", ["tools/catalog-db-write-rehearsal.mjs", "--self-test"]);
  run("node", ["tools/catalog-db-cutover-audit.mjs"]);
  run("node", ["tools/catalog-db-cutover-audit.mjs", "--self-test"]);
  ...
  run("node", ["tools/cwv-field-audit-packet.mjs"]);
  run("node", ["tools/cwv-field-audit-packet.mjs", "--self-test"]);
  run("node", ["tools/cwv-field-apply-plan.mjs", "--self-test"]);
  run("node", ["tools/content-seo-audit.mjs"]);
  run("node", ["tools/content-seo-audit.mjs", "--self-test"]);
  run("node", ["tools/content-readiness-report.mjs"]);
  run("node", ["tools/content-readiness-report.mjs", "--self-test"]);
  run("node", ["tools/final-content-packet-audit.mjs"]);
  run("node", ["tools/final-content-packet-audit.mjs", "--self-test"]);
  run("node", ["tools/final-content-apply-plan.mjs", "--self-test"]);
  run("node", ["tools/goal-readiness-report.mjs"]);
  run("node", ["tools/goal-readiness-report.mjs", "--self-test"]);
  run("node", ["tools/goal-completion-audit.mjs", "--self-test"]);
  ...
  run("node", ["tools/object-storage-env-packet-audit.mjs", "--self-test"]);
  run("node", ["tools/object-storage-apply-plan.mjs", "--self-test"]);
  run("node", ["tools/object-storage-write-smoke.mjs", "--self-test"]);
  ...
  run("node", ["tools/photo-storage-cutover-audit.mjs"]);
  run("node", ["tools/photo-storage-cutover-audit.mjs", "--self-test"]);
  ...
  run("node", ["tools/backend-evidence-smoke.mjs", "--self-test"]);
  ...
  run("node", ["tools/price-groups-smoke.mjs"]);
  run("node", ["tools/vps-preflight.mjs", "--self-test"]);
  run("node", ["tools/production-smoke.mjs", "--self-test"]);
  run("node", ["tools/canonical-url-smoke.mjs", "--self-test"]);
  run("node", ["tools/production-performance-smoke.mjs", "--self-test"]);
  run("node", ["tools/production-storage-readiness.mjs", "--self-test"]);
  run("node", ["tools/cache-warmup-smoke.mjs", "--self-test"]);
  run("node", ["tools/production-workflow-audit.mjs"]);
  run("node", ["tools/production-workflow-audit.mjs", "--self-test"]);
  run("node", ["tools/rust-account-orders-admin-cutover-audit.mjs"]);
  run("node", ["tools/rust-account-orders-admin-cutover-audit.mjs", "--self-test"]);
  run("node", ["tools/rust-account-route-rehearsal.mjs", "--self-test"]);
  run("node", ["tools/rust-ssr-cutover-audit.mjs"]);
  run("node", ["tools/rust-ssr-cutover-audit.mjs", "--self-test"]);
  run("node", ["tools/rust-ssr-route-rehearsal.mjs", "--self-test"]);
  ...
  run("node", ["tools/rust-auth-me-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-auth-write-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-orders-write-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-orders-briefs-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-admin-orders-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-admin-users-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-admin-content-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-admin-pim-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-admin-prices-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-admin-catalog-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-admin-import-batches-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/rust-admin-media-cutover-smoke.mjs", "--self-test"]);
  run("node", ["tools/access-audit.mjs"]);
  run("node", ["tools/error-log-audit.mjs"]);
  run("node", ["tools/security-posture-audit.mjs"]);
