...
function main() {
  ...
  ["app.js", "cart.js", "components/site-shell.js", "tools/static-server.mjs", "tools/bulk-upload-product-photos.mjs", "tools/bulk-upload-product-photos.test.mjs"].forEach((file) => run("node", ["--check", file]));
