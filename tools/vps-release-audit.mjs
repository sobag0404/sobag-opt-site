...
const REQUIRED_FILES = [
  ...
  "tools/rust-ssr-browser-smoke.mjs",
  "tools/rust-ssr-cutover-audit.mjs",
  "tools/rust-ssr-route-rehearsal.mjs",
  ...
  "tools/rust-admin-pim-cutover-smoke.mjs",
...
const REQUIRED_SCRIPTS = {
  ...
  "backup:evidence": "tools/backend-evidence-smoke.mjs",
  "backup:evidence:self-test": "tools/backend-evidence-smoke.mjs --self-test",
  ...
  "smoke:cache-warmup": "tools/cache-warmup-smoke.mjs",
  "smoke:rust:shadow": "tools/rust-catalog-shadow-smoke.mjs",
  "smoke:rust:ssr": "tools/rust-ssr-smoke.mjs",
  "smoke:rust:ssr-browser": "tools/rust-ssr-browser-smoke.mjs",
  "smoke:rust:auth-me": "tools/rust-auth-me-shadow-smoke.mjs",
  "smoke:rust:auth-me-cutover": "tools/rust-auth-me-cutover-smoke.mjs",
  "smoke:rust:auth-write-cutover": "tools/rust-auth-write-cutover-smoke.mjs",
  "smoke:rust:orders-write": "tools/rust-orders-write-smoke.mjs",
  "smoke:rust:orders-write:redis": "tools/rust-orders-write-smoke.mjs --store-provider redis",
  "smoke:rust:orders-briefs-cutover": "tools/rust-orders-briefs-cutover-smoke.mjs",
  "smoke:rust:orders-briefs-cutover:redis": "tools/rust-orders-briefs-cutover-smoke.mjs --store-provider redis",
  ...
  "smoke:rust:admin-pim-cutover": "tools/rust-admin-pim-cutover-smoke.mjs",
  "smoke:rust:admin-media-cutover": "tools/rust-admin-media-cutover-smoke.mjs",
...
const REQUIRED_VPS_DEPLOY_MARKERS = [
  ...
  "node tools/rust-admin-media-cutover-smoke.mjs --base-url https://sobag-shop.online",
